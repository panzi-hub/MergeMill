...
IDEs without hook support (Cursor, Windsurf, etc.) rely on skill instructions for workflow enforcement. Follow each step in the MergeMill-dev skill manually.
