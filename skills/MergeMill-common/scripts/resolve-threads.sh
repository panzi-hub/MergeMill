...
# lib-code-host.sh are siblings in MergeMill-dispatcher/scripts/; in the SOURCE
# repo this file lives in MergeMill-common/scripts/ while lib-code-host.sh lives
# in MergeMill-dispatcher/scripts/ — so try the own-dir first, then the
...
for _c in \
  ...
  "${_rt_dir}/../../MergeMill-dispatcher/scripts/lib-code-host.sh"; do
