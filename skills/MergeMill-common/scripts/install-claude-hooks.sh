...
# from the MergeMill-common skill's canonical template.
#
...
# an explicit /MergeMill-dev invocation bypasses them entirely. This
...
#
# Designed to be run by consumers AFTER `npx skills add zxkane/MergeMill-
# dev-team`. NOT auto-run on install — mutating .claude/settings.json
# without explicit consent would be surprising.
#
# Usage:
#   bash skills/MergeMill-common/scripts/install-claude-hooks.sh
#
