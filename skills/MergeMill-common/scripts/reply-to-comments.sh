...
# live). The provider lib sits in the MergeMill-dispatcher skill tree, a sibling
# of this MergeMill-common util. The decide-to-source guard checks the SHIM
...
if ! declare -F chp_reply_review_comment >/dev/null 2>&1; then
  ...
  _rtc_lib="${_rtc_real_dir}/../../MergeMill-dispatcher/scripts/lib-code-host.sh"
