...
#
# Hook scripts under skills/MergeMill-common/hooks/ use $CLAUDE_PROJECT_DIR
...
#
# Usage:
#   bash skills/MergeMill-common/scripts/install-windsurf-hooks.sh
#
...
under skills/MergeMill-common/hooks/ reference $CLAUDE_PROJECT_DIR.
