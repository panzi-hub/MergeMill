# Cross-Platform Notes — MergeMill-dev
...
|---------|--------------|-------|
| Claude Code | Full | `hooks/README.md` (in `MergeMill-common`) |
| Kiro CLI | Full | `hooks/README.md` (in `MergeMill-common`) |
...
If your IDE supports hooks, install them from `MergeMill-common/hooks/` for hard enforcement of the MANDATORY steps. Without hooks, the discipline is the same — you just have to remember to run each step yourself.
