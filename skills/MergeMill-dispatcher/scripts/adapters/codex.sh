...
# Operator-tunable via CODEX_REVIEW_MAX_RERUNS in MergeMill.conf; 0 disables the
...
# any recorded PGID/marker set — see MergeMill-review.sh's post-resolution reap
