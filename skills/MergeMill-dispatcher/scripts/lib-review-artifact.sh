...
# tree, OUTSIDE `skills/MergeMill-dispatcher/`. `npx skills add` copies only the
# skill directory, so on a packaged install (the lib sourced from
# ~/.agents/skills/MergeMill-dispatcher/scripts/) `../../../docs/...` does NOT
