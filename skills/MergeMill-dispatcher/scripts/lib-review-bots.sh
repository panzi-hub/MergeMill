...
#
# Replaces the hardcoded /q review enforcement in MergeMill-review.sh
# with a configurable per-project REVIEW_BOTS setting (PR-12).
#
# Usage (sourced by MergeMill-review.sh):
#
...
#
# Validation here is fail-fast: an unknown bot in MergeMill.conf
