...
assert_contains "TC-PCONF-051: github resolves under skills/MergeMill-dispatcher" "skills/MergeMill-dispatcher/scripts/providers" "$gh_dir"
...
assert_contains "TC-RGH-001: gitlab resolves under skills/MergeMill-dispatcher/scripts/providers (same as github, filename prefix disambiguates)" \
  "skills/MergeMill-dispatcher/scripts/providers" "$gl_dir"
