...
#   - skills/MergeMill-common/hooks/lib.sh: read_hook_stdin timeout wrap (RC6),
...
HOOKS="$PROJECT_ROOT/skills/MergeMill-common/hooks"
...
env -u MERGEMILL_CONF_DIR -u PROJECT_DIR \
