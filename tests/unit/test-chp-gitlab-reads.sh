...
# skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.sh against the
...
CAPS="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.caps"
