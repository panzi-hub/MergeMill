...
#   - happy path (clean MergeMill + transitional) still picked up
#
...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-dispatch.sh"
...
_MOCK_ISSUE_LIST="[$(mkissue 301 MergeMill pending-review approved)]"
...
_MOCK_ISSUE_LIST="[$(mkissue 302 MergeMill pending-review stalled)]"
out=$(list_pending_review)
assert_count "TC-PREV-002 pending-review+stalled excluded" 0 "$out"

# TC-PREV-003: clean pending-review → still picked up
_MOCK_ISSUE_LIST="[$(mkissue 303 MergeMill pending-review)]"
out=$(list_pending_review)
...
_MOCK_ISSUE_LIST="[$(mkissue 304 MergeMill pending-review reviewing)]"
out=$(list_pending_review)
...
_MOCK_ISSUE_LIST="[$(mkissue 401 MergeMill pending-dev approved)]"
...
_MOCK_ISSUE_LIST="[$(mkissue 402 MergeMill pending-dev stalled)]"
out=$(list_pending_dev)
assert_count "TC-PDEV-002 pending-dev+stalled excluded" 0 "$out"

# TC-PDEV-003: clean pending-dev → still picked up
_MOCK_ISSUE_LIST="[$(mkissue 403 MergeMill pending-dev)]"
out=$(list_pending_dev)
...
_MOCK_ISSUE_LIST="[$(mkissue 500 MergeMill approved pending-review pending-dev)]"
...
_MOCK_ISSUE_LIST="[$(mkissue 601 MergeMill team-a),$(mkissue 602 MergeMill team-b)]"
out=$(list_new_issues)
...
ISSUE_FILTER="label:team-a"
_MOCK_ISSUE_LIST="[$(mkissue 611 MergeMill pending-review team-a),$(mkissue 612 MergeMill pending-review team-b)]"
out=$(list_pending_review)
...
ISSUE_FILTER="label:team-a"
_MOCK_ISSUE_LIST="[$(mkissue 621 MergeMill pending-dev team-a),$(mkissue 622 MergeMill pending-dev team-b)]"
out=$(list_pending_dev)
...
ISSUE_FILTER="label:team-a"
_MOCK_ISSUE_LIST="[$(mkissue 631 MergeMill in-progress team-a),$(mkissue 632 MergeMill reviewing team-b)]"
...
ISSUE_FILTER="label:team-a"
_MOCK_ISSUE_LIST="[$(mkissue 641 MergeMill approved in-progress team-a),$(mkissue 642 MergeMill approved in-progress team-b)]"
...
_MOCK_ISSUE_LIST="[$(mkissue_a 651 "alice,bob" MergeMill team-a),$(mkissue_a 652 "carol" MergeMill team-a)]"
out=$(list_new_issues)
...
unset ISSUE_FILTER ISSUE_FILTER_JQ ISSUE_FILTER_ARGS
_MOCK_ISSUE_LIST="[$(mkissue 661 MergeMill)]"
out=$(list_new_issues)
...
_MOCK_ISSUE_LIST="[$(mkissue 701 MergeMill in-progress team-a),$(mkissue 702 MergeMill reviewing team-a)]"
unset ISSUE_FILTER ISSUE_FILTER_JQ ISSUE_FILTER_ARGS
...
_MOCK_ISSUE_LIST="[$(mkissue 711 MergeMill in-progress team-a),$(mkissue 712 MergeMill reviewing team-b)]"
unset ISSUE_FILTER ISSUE_FILTER_JQ ISSUE_FILTER_ARGS
unfiltered_count=$(count_active)
ISSUE_FILTER="label:team-a"
filtered_count=$(count_active)
...
_MOCK_ISSUE_LIST="[$(mkissue 721 MergeMill in-progress team-a),$(mkissue 722 MergeMill reviewing team-b)]"
unset ISSUE_FILTER ISSUE_FILTER_JQ ISSUE_FILTER_ARGS
unfiltered_count=$(count_active)
ISSUE_FILTER="   "
