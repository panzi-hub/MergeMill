...
# ===========================================================================
_MOCK_ISSUE_LIST="[$(mkissue 10 MergeMill pending-review approved),$(mkissue 11 MergeMill pending-review)]"
assert_numbers_eq "TC-W1A-PARITY-030 list_pending_review.residue" "list_pending_review.residue" "$(list_pending_review)"

_MOCK_ISSUE_LIST="[$(mkissue 12 MergeMill pending-dev stalled),$(mkissue 13 MergeMill pending-dev)]"
assert_numbers_eq "TC-W1A-PARITY-031 list_pending_dev.residue" "list_pending_dev.residue" "$(list_pending_dev)"

_MOCK_ISSUE_LIST="[$(mkissue 14 MergeMill in-progress approved),$(mkissue 15 MergeMill in-progress)]"
assert_numbers_eq "TC-W1A-PARITY-032 list_stale_candidates.residue" "list_stale_candidates.residue" "$(list_stale_candidates)"

_MOCK_ISSUE_LIST="[$(mkissue 16 MergeMill approved in-progress),$(mkissue 17 MergeMill stalled pending-dev),$(mkissue 18 MergeMill in-progress)]"
assert_numbers_eq "TC-W1A-PARITY-033 list_hygiene_residue.residue" "list_hygiene_residue.residue" "$(list_hygiene_residue)"

_MOCK_ISSUE_LIST="[$(mkissue 19 MergeMill in-progress approved),$(mkissue 20 MergeMill reviewing)]"
