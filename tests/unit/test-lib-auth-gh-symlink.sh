...
# in skills/MergeMill-dev/SKILL.md Step 12 and
# skills/MergeMill-dev/references/MergeMill-mode.md works regardless of
# GH_AUTH_MODE.
#
...
WRAPPER="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/gh-with-token-refresh.sh"
