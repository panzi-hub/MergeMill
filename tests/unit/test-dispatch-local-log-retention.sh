...
# (MergeMill.conf + stub dev/review wrappers that record argv and stay alive
...
make_stub "$PROJ/scripts/MergeMill-dev.sh"
make_stub "$PROJ/scripts/MergeMill-review.sh"
