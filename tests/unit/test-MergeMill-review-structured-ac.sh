#!/bin/bash
# test-MergeMill-review-structured-ac.sh — issue #183 / INV-49.
#
...
#   3. source-of-truth greps against MergeMill-review.sh / lib-review-e2e.sh +
#      doc-presence checks.
#
# Run: bash tests/unit/test-MergeMill-review-structured-ac.sh
