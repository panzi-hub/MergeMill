...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-code-host.sh
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-provider-prompts.sh
source "$SCRIPTS_DIR/lib-provider-prompts.sh"
CODE_HOST=github
ISSUE_PROVIDER=github
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-bots.sh
source "$LIB"
