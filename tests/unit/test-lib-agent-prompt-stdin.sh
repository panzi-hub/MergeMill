...
# Drop ambient MergeMill.conf state. The agent that runs this test may
# have inherited MERGEMILL_CONF / AGENT_LAUNCHER / AGENT_PERMISSION_MODE
...
unset MERGEMILL_CONF MERGEMILL_CONF_LOADED_FROM
...
ADAPTER_DIR="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/adapters"
