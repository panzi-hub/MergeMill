...
# orchestration lives in MergeMill-review.sh and is covered by the
# source-of-truth + stub-mode harness in test-MergeMill-review-smoke-gate.sh.
...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-smoke.sh"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-smoke.sh
source "$LIB"
