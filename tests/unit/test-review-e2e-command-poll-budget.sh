...
CONF="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/MergeMill.conf.example"
...
if [[ -f "$POLL_LIB" ]]; then
  # shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-poll.sh
  source "$POLL_LIB"
...
assert_grep "TC-RPB-DOC-06 MergeMill.conf.example cross-references the two windows (#172/INV-43)" \
  '172|INV-43' "$CONF"
