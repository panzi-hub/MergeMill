...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-postfail.sh"
...
export MERGEMILL_PID_DIR="$PIDDIR"
...
LIBCONFIG="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-config.sh"
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-config.sh
[[ -f "$LIBCONFIG" ]] && source "$LIBCONFIG"

# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-postfail.sh
source "$LIB"
...
# ---------------------------------------------------------------------------
echo "=== TC-PF-SRC: source-of-truth wiring (MergeMill-review.sh) ==="
# ---------------------------------------------------------------------------
...
for f in "$LIB" \
         "$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/post-verdict.sh" \
         "$WRAPPER"; do
