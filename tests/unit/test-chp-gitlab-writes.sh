...
# skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.sh + the
...
LEAF="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.sh"
GH_LEAF="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/providers/chp-github.sh"
CHP_LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-code-host.sh"
UPLOAD_SH="$PROJECT_ROOT/skills/MergeMill-review/scripts/upload-screenshot.sh"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.sh
source "$LEAF"
...
CAPS_FILE="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/providers/chp-gitlab.caps"
...
(
  ...
  # shellcheck source=../../skills/MergeMill-dispatcher/scripts/providers/chp-github.sh
  source "$GH_LEAF"
...
# missing_bot_reviews threads from MergeMill.conf's REPO) is URL-encoded
