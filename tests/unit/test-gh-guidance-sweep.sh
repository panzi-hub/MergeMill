...
HOOK="$PROJECT_ROOT/skills/MergeMill-common/hooks/block-push-to-main.sh"
...
assert_count "skills/MergeMill-common/hooks/block-push-to-main.sh"           1  "TC-GHSWEEP-003"
assert_count "skills/MergeMill-dev/SKILL.md"                                 6  "TC-GHSWEEP-004"
assert_count "skills/MergeMill-dev/references/review-commands.md"           26  "TC-GHSWEEP-005"
assert_count "skills/MergeMill-dev/references/review-threads.md"             9  "TC-GHSWEEP-006"
assert_count "skills/MergeMill-dev/references/MergeMill-mode.md"           12  "TC-GHSWEEP-007"
assert_count "skills/MergeMill-review/SKILL.md"                             13  "TC-GHSWEEP-008"
assert_count "skills/MergeMill-review/references/decision-gate.md"           9  "TC-GHSWEEP-009"
assert_count "skills/MergeMill-review/references/merge-conflict-resolution.md" 4 "TC-GHSWEEP-010"
assert_count "skills/MergeMill-dispatcher/SKILL.md"                          1  "TC-GHSWEEP-011"
...
SWEPT_MARKDOWN=(
  "skills/MergeMill-dev/SKILL.md"
  "skills/MergeMill-dev/references/review-commands.md"
  "skills/MergeMill-dev/references/review-threads.md"
  "skills/MergeMill-dev/references/MergeMill-mode.md"
  "skills/MergeMill-review/SKILL.md"
  "skills/MergeMill-review/references/decision-gate.md"
  "skills/MergeMill-review/references/merge-conflict-resolution.md"
  "skills/MergeMill-dispatcher/SKILL.md"
