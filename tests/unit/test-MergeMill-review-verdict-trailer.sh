#!/bin/bash
# test-MergeMill-review-verdict-trailer.sh — INV-35 / issue #149.
#
...
# logic lives in skills/MergeMill-dispatcher/scripts/lib-review-verdict.sh
...
#
# Run: bash tests/unit/test-MergeMill-review-verdict-trailer.sh
...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-verdict.sh"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-verdict.sh
source "$LIB"
set +e
...
# (from MergeMill.conf); every emit_verdict_trailer caller passes $REPO as arg2, so
...
# passed
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "passed" ""
...
# failed-substantive
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-substantive" ""
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-non-substantive" "bot-timeout"
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-non-substantive" ""
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "wat" ""
rc=$?
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-non-substantive" "bot-timeout; rm -rf /"
rc=$?
if [[ $rc -eq 0 ]]; then
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-non-substantive" "BOT_Timeout"
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-substantive" "" "false"
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-substantive" "" "true"
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-non-substantive" "bot-timeout" "false"
if [[ "$_MOCK_LAST_COMMENT_BODY" != *"dev-actionable"* ]]; then
...
reset
emit_verdict_trailer 149 "panzi-hub/MergeMill" "failed-substantive" "" "garbage"
