...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-kiro.sh"
AGY_LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-agy.sh"
CODEX_LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-review-codex.sh"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-kiro.sh
source "$LIB"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-review-agy.sh
source "$AGY_LIB"
...
if bash -n "$WRAPPER" 2>/dev/null; then
  echo -e "  ${GREEN}PASS${NC}: TC-KIRO-DROP-SRC-05b MergeMill-review.sh parses (bash -n)"; PASS=$((PASS + 1))
else
  echo -e "  ${RED}FAIL${NC}: TC-KIRO-DROP-SRC-05b MergeMill-review.sh fails bash -n"; FAIL=$((FAIL + 1))
fi
