...
assert_missing_file \
  ...
  "$PROJECT_ROOT/skills/MergeMill-common/hooks/post-file-edit-reminder.sh"
...
assert_not_references \
  "skills/MergeMill-dev/SKILL.md does not reference post-file-edit-reminder" \
  "$PROJECT_ROOT/skills/MergeMill-dev/SKILL.md" \
  "post-file-edit-reminder"
