...
# MergeMill-dev.sh:257-260 already falls back to MODE=new when --mode
...
# expects (MergeMill.conf + MergeMill-dev.sh stub that records its argv).
# ---------------------------------------------------------------------------
...
# Stub MergeMill-dev.sh: record argv to a deterministic file and exit 0
