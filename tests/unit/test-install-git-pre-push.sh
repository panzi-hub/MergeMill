...
INSTALLER="$PROJECT_ROOT/skills/MergeMill-common/hooks/install-git-pre-push.sh"
...
if grep -q 'managed by MergeMill-common' "$TMPDIR/repo1/.git/hooks/pre-push"; then
