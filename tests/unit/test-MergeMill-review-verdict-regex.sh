#!/bin/bash
# test-MergeMill-review-verdict-regex.sh — verify the verdict-detection
# logic in MergeMill-review.sh recognizes common pass/fail phrasings,
...
# MergeMill-review.sh, drive them against synthetic comments JSON
...
#
# Run: bash tests/unit/test-MergeMill-review-verdict-regex.sh
