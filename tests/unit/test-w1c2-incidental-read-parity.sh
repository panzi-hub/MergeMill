...
#
#   site1_approved_at (MergeMill-dev.sh:604)
#   site2_preview_url (MergeMill-review.sh:918)
#   site3_head_ref_name (MergeMill-review.sh:948)
#   site4_head_ref_oid  (MergeMill-review.sh:949)
#   site5_state (MergeMill-review.sh:1591)
#   site6_state (MergeMill-review.sh:3312)
#   site7_wait_count (MergeMill-review.sh:3357)
#   site8_evidence_body (lib-review-e2e.sh:262)
#   site9_inline_comments (MergeMill-dev.sh:1091 formatter)
#
...
# =========================================================================
# Site 1: approved-timestamp (MergeMill-dev.sh:604)
...
# =========================================================================
echo "=== Site 1 — approved-timestamp (MergeMill-dev.sh:604) ==="
...
# =========================================================================
# Site 2: preview URL (MergeMill-review.sh:918)
...
# =========================================================================
echo "=== Site 2 — preview URL (MergeMill-review.sh:918) ==="
...
# =========================================================================
# Site 3+4: branch + SHA (MergeMill-review.sh:948/:949)
...
# =========================================================================
echo "=== Site 3+4 — branch + SHA (MergeMill-review.sh:948/:949) ==="
...
# =========================================================================
# Site 5+6: state token → _pr_open_gate (MergeMill-review.sh:1591/:3312)
...
# =========================================================================
# Site 7: bot-review-wait count (MergeMill-review.sh:3357)
...
# =========================================================================
echo "=== Site 7 — bot-review-wait count (MergeMill-review.sh:3357) ==="
...
# =========================================================================
# Site 9: inline-comment formatter (MergeMill-dev.sh:1091)
#
...
# =========================================================================
echo "=== Site 9 — inline-comment formatter (MergeMill-dev.sh:1091) ==="
...
CHP_GITHUB="$SCRIPT_DIR/../../skills/MergeMill-dispatcher/scripts/providers/chp-github.sh"
...
EOF_PAYLOAD
  ...
  # MergeMill-dev.sh would silently drop review feedback from the dev-resume
