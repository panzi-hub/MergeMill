...
#   2. source-of-truth greps against MergeMill-review.sh: Method 1 uses the
...
LINKAGE_LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-pr-linkage.sh"
...
# ---------------------------------------------------------------------------
echo "=== source-of-truth: MergeMill-review.sh wiring ==="
# ---------------------------------------------------------------------------
