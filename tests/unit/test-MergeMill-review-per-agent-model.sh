#!/bin/bash
# test-MergeMill-review-per-agent-model.sh — issue #168 / INV-41.
#
...
#      truth table.
#   2. Source-of-truth greps against MergeMill-review.sh: assert the fan-out
...
#      wrapper.
#
# Run: bash tests/unit/test-MergeMill-review-per-agent-model.sh
...
AGY_ADAPTER="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/adapters/agy.sh"
...
# ---------------------------------------------------------------------------
echo "=== TC-PAM-SRC: source-of-truth greps against MergeMill-review.sh ==="
# ---------------------------------------------------------------------------
...
echo "=== TC-PAM-SRC-07: bash -n on MergeMill-review.sh ==="
