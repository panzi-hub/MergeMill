#!/bin/bash
# test-MergeMill-review-e2e-gate-open-guard.sh — issue #195 / INV-54 extension.
#
...
#   2. Source-of-truth greps against MergeMill-review.sh: assert the E2E-gate
...
#
# Run: bash tests/unit/test-MergeMill-review-e2e-gate-open-guard.sh
