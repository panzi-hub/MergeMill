#!/bin/bash
# test-MergeMill-review-fail-branch-open-guard.sh — issue #196 / INV-54.
#
...
#   2. Source-of-truth greps against MergeMill-review.sh: assert the guard is
#      hoisted ahead of the block branches and the redundant PASS-branch
#      duplicate was removed — without executing the wrapper.
#
# Run: bash tests/unit/test-MergeMill-review-fail-branch-open-guard.sh
