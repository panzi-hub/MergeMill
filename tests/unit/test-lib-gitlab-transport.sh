...
#
# Drives skills/MergeMill-dispatcher/scripts/providers/lib-gitlab-transport.sh
...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/providers/lib-gitlab-transport.sh"
