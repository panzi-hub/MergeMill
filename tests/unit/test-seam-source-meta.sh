...
#      skills/MergeMill-dispatcher/scripts/lib-*.sh that makes COMMAND-POSITION
...
#   - test-MergeMill-review-sequential-e2e.sh / test-MergeMill-review-structured-ac.sh:
...
WAIVERS=(
  ...
  "test-MergeMill-review-sequential-e2e.sh:lib-review-e2e.sh:owned by open PR #337 (adds sandbox seam repairs); remove waiver post-#337"
  "test-MergeMill-review-structured-ac.sh:lib-review-e2e.sh:owned by open PR #337 (adds sandbox seam repairs); remove waiver post-#337"
  ...
  "test-MergeMill-review-verdict-via-helper.sh:dynamic-source:_FN_SLICE is a mktemp function-slice fixture authored inline by this test"
