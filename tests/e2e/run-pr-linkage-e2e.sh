...
# WHAT IT DOES
# ------------
# Simulates the real cross-wiring scenario that drove #277: two MergeMill
...
#
#   skills/MergeMill-dispatcher/scripts/lib-pr-linkage.sh
...
LIB="$PROJECT_ROOT/skills/MergeMill-dispatcher/scripts/lib-pr-linkage.sh"
...
# shellcheck source=../../skills/MergeMill-dispatcher/scripts/lib-pr-linkage.sh
source "$LIB"
