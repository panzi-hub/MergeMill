...
# real fixture project layout (fixture `MergeMill-dev.sh`/
# `MergeMill-review.sh` on PATH, a real `MergeMill.conf`, symlinked libs —
...
MARKER01="$STATE_ROOT/MergeMill-e2e-lgc6/lanes/.defer-issue-${ISSUE_NUM}"
if [[ -f "$MARKER01" ]]; then
