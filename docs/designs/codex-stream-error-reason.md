...
- The `MergeMill-review.sh` drop-reason assembly loop only enriches the reason
...
(simpler, more maintainable — MergeMill decision guideline). A genuine
