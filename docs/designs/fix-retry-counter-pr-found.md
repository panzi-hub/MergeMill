...
An MergeMill issue was marked `stalled` right after the review agent completed
...
`skills/MergeMill-dispatcher/SKILL.md` Step 4 retry-count regex matches
...
1. `skills/MergeMill-dispatcher/SKILL.md` Step 4:
...
2. `skills/MergeMill-dispatcher/SKILL.md` Step 5:
