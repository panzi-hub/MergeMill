...
- `skills/MergeMill-dispatcher/scripts/lib-review-agy.sh` — NEW (detector + phrase helper)
- `skills/MergeMill-dispatcher/scripts/MergeMill-review.sh` — source the lib; capture agy logs; augment drop reason; fix model labels
- `docs/pipeline/invariants.md` — INV-58
- `docs/pipeline/review-agent-flow.md` — detector + label-fix walkthrough
- `skills/MergeMill-dispatcher/scripts/MergeMill.conf.example` — note the new diagnostic
