...
- `skills/MergeMill-common/SKILL.md` Setup table: add the 2 final installers; remove the "coming in PR-11c" stub.
...
New:
- `skills/MergeMill-common/scripts/install-windsurf-hooks.sh`
- `skills/MergeMill-common/scripts/install-kimi-hooks.sh`
...
Modified:
- `skills/MergeMill-common/scripts/lib-installer-translate.sh` — new `fold_matcher_into_event` helper
- `docs/cross-agent-hooks.md` — matrix updated, Windsurf + Kimi marked shipped
- `skills/MergeMill-common/SKILL.md` — Setup table extended
