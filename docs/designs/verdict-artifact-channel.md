...
|---|---|---|---|
| **dev-resume** | `Review findings:` change-request comment (INV-57 post-approval) | MergeMill-dev.sh:391,757 | render-format pin test |
...
## Decisions (MergeMill, per Decision-Making Guidelines)
