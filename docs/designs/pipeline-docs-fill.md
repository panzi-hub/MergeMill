...
- `docs/MergeMill-pipeline.md` — add a pointer to `docs/pipeline/`
...
- `skills/MergeMill-dispatcher/SKILL.md` (the prompt the dispatcher agent reads + executes)
- `skills/MergeMill-dispatcher/scripts/dispatch-local.sh` (kill-stale-wrapper logic)
- `skills/MergeMill-dispatcher/scripts/MergeMill-dev.sh` (dev wrapper)
- `skills/MergeMill-dispatcher/scripts/MergeMill-review.sh` (review wrapper)
- `skills/MergeMill-dispatcher/scripts/lib-agent.sh` (run/resume agent + acquire_pid_guard)
- `skills/MergeMill-dispatcher/scripts/lib-auth.sh` (token lifecycle)
- `skills/MergeMill-dev/SKILL.md` (dev-agent skill the wrapper invokes)
- `skills/MergeMill-review/SKILL.md` (review-agent skill the wrapper invokes)
