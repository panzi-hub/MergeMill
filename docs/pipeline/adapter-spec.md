...
[`lib-agent.sh`](../../skills/MergeMill-dispatcher/scripts/lib-agent.sh) and
...
[`post-verdict.sh`](../../skills/MergeMill-dispatcher/scripts/post-verdict.sh)
...
[`skills/MergeMill-dispatcher/scripts/adapters/<cli>.sh`](../../skills/MergeMill-dispatcher/scripts/adapters/)
...
- [`MergeMill-pipeline.md`](../MergeMill-pipeline.md) — the orientation doc this spec is linked from.
