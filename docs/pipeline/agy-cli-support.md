...
successor to / replacement for the Gemini CLI in the MergeMill
...
## Operator-facing config (`MergeMill.conf` snippet)

`MergeMill.conf.example` gains an `# agy block` mirroring the existing
