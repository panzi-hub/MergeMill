...
E2E (End-to-End) verification is an optional but powerful component of the MergeMill review pipeline. When enabled, the review agent uses Chrome DevTools MCP to navigate a deployed preview of the PR, execute test cases against a live environment, and capture screenshots as evidence.

This document explains how to configure E2E verification for your project.

## Configuration Variables

All E2E configuration is set in `scripts/MergeMill.conf`:
