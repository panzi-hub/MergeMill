...
|----|----------|------------------|
| TC-VBN-01 | Source grep: bare `/tmp/verdict-${_agent_name}.md` form in `MergeMill-review.sh` | Absent |
...
Verified against pre-fix `MergeMill-review.sh`/`post-verdict.sh` (current
...
- `tests/unit/test-MergeMill-review-verdict-via-helper.sh` (TC-PVP-12):
