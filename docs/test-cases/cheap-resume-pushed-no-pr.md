...
Scope: `skills/MergeMill-dispatcher/scripts/MergeMill-dev.sh` — the `needs_open_pr_only`
...
source-of-truth greps (same pattern as `test-MergeMill-dev-rebase-marker.sh`).
