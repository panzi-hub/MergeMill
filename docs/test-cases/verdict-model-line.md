...
in the live `MergeMill.conf`):

```bash
env -u PROJECT_DIR bash tests/unit/test-post-verdict.sh
env -u PROJECT_DIR bash tests/unit/test-MergeMill-review-verdict-via-helper.sh
```
...
## `tests/unit/test-MergeMill-review-verdict-via-helper.sh` (extends TC-PVP-NN)
...
- `tests/unit/test-MergeMill-review-verdict-via-helper.sh` TC-PVP-01..06
- `tests/unit/test-MergeMill-review-per-agent-model.sh` (INV-41 resolution untouched)
- `tests/unit/test-MergeMill-review-multi-agent.sh` (INV-40 attribution untouched)
