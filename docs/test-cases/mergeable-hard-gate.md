...
## 2. Source-of-truth greps — `MergeMill-review.sh`
...
- `test-MergeMill-review-auto-merge-failure.sh` — `Auto-merge failed:` marker
  ...
  closes the issue).
- `test-MergeMill-review-prompt.sh` — Step-0 mergeable prompt text retained.
- `test-MergeMill-review-verdict-trailer.sh` — trailer schema unchanged; new
