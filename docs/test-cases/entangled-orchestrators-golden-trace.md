...
| TC-HCGT-015 | degraded fake-provider selection (`ISSUE_PROVIDER=degraded` + `MERGEMILL_PROVIDERS_DIR` override, verbs still recorded) emits the IDENTICAL verb SEQUENCE for Branch C — proving the orchestrator's verb glue does not branch on caps |
