...
Unit suite: `tests/unit/test-MergeMill-review-structured-ac.sh`.
...
| TC-AC-REG-02 | existing `test-MergeMill-review-sequential-e2e.sh` stays green | all #182 tests pass |
