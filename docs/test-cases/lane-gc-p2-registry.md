...
1. **New `skills/MergeMill-dispatcher/scripts/lib-lane.sh`** — `lane_mint`,
...
| TC-LGC2-004 | Registry existence before ANY spawn (review wrapper) | same as TC-LGC2-003, mirrored for `MergeMill-review.sh` |
...
| TC-LGC2-022 | Review wrapper source-of-truth: same ordering | grep-pin mirrored for `MergeMill-review.sh` |
