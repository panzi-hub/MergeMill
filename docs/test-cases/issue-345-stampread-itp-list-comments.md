...
Test file: `tests/unit/test-MergeMill-review-sequential-e2e.sh` (TC-SE2E-STAMP
section, extended in place — the function under test already lived there since
#182/#182-codex-review).
Run: `env -u PROJECT_DIR bash tests/unit/test-MergeMill-review-sequential-e2e.sh`
