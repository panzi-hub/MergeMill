...
**Setup**: Operator set `REVIEW_RETRY_LIMIT=0` in `MergeMill.conf`. Issue has 5 prior flips for the current session.
...
| Test-case doc + unit tests written and passing | This doc + `tests/unit/test-classify-recent-review-verdict.sh` (16 PASS) + `tests/unit/test-handle-completed-session-routing.sh` (47 PASS) + `tests/unit/test-is-session-completed-end-ts.sh` (8 PASS) + `tests/unit/test-MergeMill-review-verdict-trailer.sh` (9 PASS) |
