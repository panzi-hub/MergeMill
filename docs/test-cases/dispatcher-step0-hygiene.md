...
|----|---|---|
| TC-HAS-TERM-001 | `MergeMill, approved` | 0 (truthy) |
| TC-HAS-TERM-002 | `MergeMill, stalled` | 0 |
| TC-HAS-TERM-003 | `MergeMill, in-progress` | 1 (falsy) |
| TC-HAS-TERM-004 | `MergeMill` | 1 |
| TC-HAS-TERM-005 | `MergeMill, approved, stalled` | 0 (both qualify) |
...
|----|---|---|---|
| TC-HYG-001 | `MergeMill, approved, pending-review` | `pending-review` | One transitional residue under approved |
| TC-HYG-002 | `MergeMill, approved, in-progress, stalled` | `in-progress` | Both terminals present; only transitional removed |
| TC-HYG-003 | `MergeMill, approved, in-progress, reviewing, pending-dev, pending-review` | `in-progress, reviewing, pending-dev, pending-review` | All four transitionals stripped in one call |
| TC-HYG-004 | `MergeMill, stalled, pending-dev` | `pending-dev` | Stalled-side residue |
| TC-HYG-005 | `MergeMill, approved` | (no edit call) | Already clean — no-op |
| TC-HYG-006 | `MergeMill, in-progress` | (no edit call) | Not a terminal-residue case |
