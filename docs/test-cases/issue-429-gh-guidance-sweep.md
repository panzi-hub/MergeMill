...
| File | Count |
|------|------:|
| `skills/MergeMill-common/SKILL.md` | 0 |
| `skills/MergeMill-review/references/e2e-verification.md` | 0 |
| `skills/MergeMill-dev/references/commit-conventions.md` | 0 |
| `skills/create-issue/references/issue-templates.md` | 0 |
| `skills/create-issue/references/workspace-changes.md` | 0 |

The other MergeMill-review references file (`e2e-verification.md`) was
...
1. **Load-bearing GitHub-lane operational rule** (MergeMill-dev/SKILL.md
   Step 12; MergeMill-mode.md Posting Issue/PR Comments). The rule is
...
2. **Scope-noted reference file** (review-commands.md, review-threads.md).
   ...
   seams.
3. **Placeholder-form INV-52 / INV-44 statement** (MergeMill-review/SKILL.md,
...
4. **Two-example command block** (create-issue/SKILL.md, MergeMill-dev/SKILL.md
   commands, MergeMill-dispatcher/SKILL.md token-source). Both GitHub and
...
| TC-GHSWEEP-004 | `skills/MergeMill-dev/SKILL.md` `gh ` token count | 6 |
| TC-GHSWEEP-005 | `skills/MergeMill-dev/references/review-commands.md` `gh ` token count | 26 |
| TC-GHSWEEP-006 | `skills/MergeMill-dev/references/review-threads.md` `gh ` token count | 9 |
| TC-GHSWEEP-007 | `skills/MergeMill-dev/references/MergeMill-mode.md` `gh ` token count | 12 |
| TC-GHSWEEP-008 | `skills/MergeMill-review/SKILL.md` `gh ` token count | 13 |
| TC-GHSWEEP-009 | `skills/MergeMill-review/references/decision-gate.md` `gh ` token count | 9 |
| TC-GHSWEEP-010 | `skills/MergeMill-review/references/merge-conflict-resolution.md` `gh ` token count | 4 |
| TC-GHSWEEP-011 | `skills/MergeMill-dispatcher/SKILL.md` `gh ` token count | 1 |
...
- The dispatcher-tree prompt fragments (`MergeMill-dev.sh` /
  `MergeMill-review.sh` / `lib-review-bots.sh`): #421, shipped.
...
- The [INV-91] cutover checker's tree scope: unchanged — every file in the
  inventory above is OUTSIDE `skills/MergeMill-dispatcher/scripts/`, so the
