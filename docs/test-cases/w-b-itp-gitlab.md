...
- **Under test**: `skills/MergeMill-dispatcher/scripts/providers/itp-gitlab.sh`
  (14 leaves `itp_gitlab_*`) + `skills/MergeMill-dispatcher/scripts/providers/itp-gitlab.caps`.
...
- Contracts: `docs/pipeline/provider-spec.md` §3.1 (per-verb) / §3.3 (comment
  ...
  research summary).
- GitHub reference leaf: `skills/MergeMill-dispatcher/scripts/providers/itp-github.sh`
