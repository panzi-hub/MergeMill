...
- **Action:** MergeMill-dev.sh starts for issue #10
- **Expected:** PID file created, script runs normally

### TC-PID-002: Second instance exits when first is running
- **Precondition:** MergeMill-dev.sh is running for issue #10 with valid PID file
- **Action:** Another MergeMill-dev.sh starts for issue #10
...
- **Precondition:** MergeMill-review.sh is running for issue #10
- **Action:** Another MergeMill-review.sh starts for issue #10
- **Expected:** Second instance logs warning and exits 0

### TC-PID-005: PID guard rejects symlinked PID files
- **Precondition:** PID file path is a symlink
- **Action:** MergeMill-dev.sh starts
