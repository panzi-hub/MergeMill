...
|---|---|---|
| TC-RGH-001 | `pcf_resolve_provider_dir <root> gitlab` | rc 0; stdout = `<root>/skills/MergeMill-dispatcher/scripts/providers` (same as github — filename prefix disambiguates) |
