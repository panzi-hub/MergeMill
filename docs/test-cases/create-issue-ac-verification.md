...
genuine post-merge/prod-only criterion into a non-blocking, non-MergeMill
follow-up — because a blocking AC the MergeMill dev/review loop cannot satisfy
...
| TC-ACV-005 | Follow-up must NOT be MergeMill | `do NOT add` + `MergeMill` |
